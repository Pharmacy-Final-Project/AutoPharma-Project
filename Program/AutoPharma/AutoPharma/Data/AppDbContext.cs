    ...
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Medicine>().HasData(
                ...
                new Medicine { Id = 3, Name = "FEXON", Dose = "180", Information = "This medicine is used as a Anti-allergic", MOHPrice = 4.95, ImageUri = new Uri(""), ExpiredDate = new DateTime(2026, 06, 28) },
                new Medicine { Id = 4, Name = "DIAX SUSP", Dose = "220", Information = "This medicine is used as a 	Intestinal antiseptic", MOHPrice = 6.95, ImageUri = new Uri(""), ExpiredDate = new DateTime(2024, 05, 26) },
                new Medicine { Id = 5, Name = "Zithrokan", Dose = "200", Information = "This medicine is used as a Antibiotics", MOHPrice = 1.2, ImageUri = new Uri(""), ExpiredDate = new DateTime(2027, 02, 01) },
                new Medicine { Id = 6, Name = "Alvedon", Dose = "500", Information = "This medicine is used as a antipyretic", MOHPrice = 2.6, ImageUri = new Uri(""), ExpiredDate = new DateTime(2024, 09, 12) },
                new Medicine { Id = 7, Name = "cyclease", Dose = "250", Information = "This medicine is used for cramps", MOHPrice = 4.7, ImageUri = new Uri(""), ExpiredDate = new DateTime(2025, 04, 19) },
                new Medicine { Id = 8, Name = "DAYQUIL", Dose = "400", Information = "This medicine is used for cold", MOHPrice = 1.1, ImageUri = new Uri(""), ExpiredDate = new DateTime(2023, 03, 14) },
                new Medicine { Id = 9, Name = "Excedrin", Dose = "200", Information = "This medicine is used for headache", MOHPrice = 9.8, ImageUri = new Uri(""), ExpiredDate = new DateTime(2027, 01, 11) }
            ...
            modelBuilder.Entity<Location>().HasData(
                ...
                new Location { Id = 12, BranchId = 2, Cabinet = 'A', Shelf = 3 },
