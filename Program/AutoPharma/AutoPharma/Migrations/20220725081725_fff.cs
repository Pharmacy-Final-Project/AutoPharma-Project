    ...
    public partial class fff : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, "250", new DateTime(2025, 4, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used for cramps", 4.7000000000000002, "cyclease" },
                    { 6, "500", new DateTime(2024, 9, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used as a antipyretic", 2.6000000000000001, "Alvedon" },
                    { 5, "200", new DateTime(2027, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used as a Antibiotics", 1.2, "Zithrokan" },
                    { 8, "400", new DateTime(2023, 3, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used for cold", 1.1000000000000001, "DAYQUIL" },
                    { 3, "180", new DateTime(2026, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used as a Anti-allergic", 4.9500000000000002, "FEXON" },
                    { 2, "500", new DateTime(2022, 8, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used as a antibiotic", 17.649999999999999, "Penicillin " },
                    ...
                    { 4, "220", new DateTime(2024, 5, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used as a 	Intestinal antiseptic", 6.9500000000000002, "DIAX SUSP" },
                    { 9, "200", new DateTime(2027, 1, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://autopharmastorage.blob.core.windows.net/images/panadol.jpg", "This medicine is used for headache", 9.8000000000000007, "Excedrin" }
                });
